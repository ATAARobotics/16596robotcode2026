...
@Autonomous(name = "Blue Far Partner Park")
public class AutoBlueFarPartnerPark extends OpMode {
...
//   private static final Location destPickupMiddleRow = new Location(920.5,-1263.6,0);
   private static final Location destPartnerPark = new Location(147.9,-144.6,0);
    ...
    public void loop() {
        ...
        if (!autoDone) {
            switch (currentWayPoint) {
                    ...
                    if (goto_xy(currentDestination, currentDriveMode) || wayPointActiveFor(3)) {
                        ...
                        if (wayPointActiveFor(9)) {
                            ...
                            if (shotCount == 10) {
                                ...
                                currentWayPoint = WayPoints.PartnerPark;
                ...
                case PartnerPark:
                    driveTrain.CurrentShooterMode = DriveTrainBasic2.ShooterMode.shooterOFF;
                    currentDestination = destPartnerPark;
                    currentDriveMode = dmRough;
                    driveTrain.setFacing(currentDestination.facing);
    ...
    public enum WayPoints {
        MoveOffWall, PickupFarRow, Far_Shot, AimLongRedShoot, MoveOffWhite, MoveOffWhiteMiddle, PickupMiddleRow, SafePark, PartnerPark, Done
    }
