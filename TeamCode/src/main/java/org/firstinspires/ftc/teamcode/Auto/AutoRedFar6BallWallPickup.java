...
@Autonomous(name = "AutoRedFar6BallWallPickup")
public class AutoRedFar6BallWallPickup extends OpMode {
    ...
    private static final Location destMoveOffWhite = new Location(-748,0,0);
    private static final Location destPickupFarRow = new Location(-857,159,0.0);
